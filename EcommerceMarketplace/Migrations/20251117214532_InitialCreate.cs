        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Stores_AspNetUsers_VendorId",
                        column: x => x.VendorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShippingRating = table.Column<int>(type: "integer", nullable: false),
                    ...
                    WouldBuyAgain = table.Column<bool>(type: "boolean", nullable: false),
                    CustomerId = table.Column<string>(type: "text", nullable: false),
                    StoreId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReviewsStore", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ReviewsStore_AspNetUsers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ReviewsStore_Stores_StoreId",
                        column: x => x.StoreId,
                        principalTable: "Stores",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    IsVerifiedPurchase = table.Column<bool>(type: "boolean", nullable: false),
                    RecommendProduct = table.Column<bool>(type: "boolean", nullable: false),
                    ProductVariation = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    FitsAsExpected = table.Column<bool>(type: "boolean", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReviewsProduct", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ReviewsProduct_AspNetUsers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ReviewsProduct_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReviewProductId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReviewProductImages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ReviewProductImages_ReviewsProduct_ReviewProductId",
                        column: x => x.ReviewProductId,
                        principalTable: "ReviewsProduct",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReviewsProduct_CustomerId",
                table: "ReviewsProduct",
                column: "CustomerId");

            migrationBuilder.CreateIndex(
                name: "IX_ReviewsProduct_ProductId",
                table: "ReviewsProduct",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_ReviewsStore_CustomerId",
                table: "ReviewsStore",
                column: "CustomerId");

            migrationBuilder.CreateIndex(
                name: "IX_ReviewsStore_StoreId",
                table: "ReviewsStore",
                column: "StoreId");
